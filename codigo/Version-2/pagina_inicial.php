...
<body class="d-flex flex-column">
    ...
    <?php 
        ...
        // si no se ha hecho una búsqueda, entonces se muestran todas las posturas
        if (!isset($_GET['filterOptions']) && !isset($_GET['keyword'])) {
            $buscadorInicial = new Buscador();
            $resultados = $buscadorInicial->buscar("", "postura"); // Assuming "postura" is the default filter
        }       
